(function () {
	...
	var imgDiffuse,imgDiffuse1, imgNormal;
	...
	function init() {
		...
		var buttx=document.getElementById("ButtonX");
			buttx.addEventListener('click', function (evt) {
							targetYaw = startYaw + 200 * 0.004;
				if(targetPitch > Math.PI / 2) {
					targetPitch = Math.PI / 2;
				} else if(targetPitch < -Math.PI / 2) {
					targetPitch = -Math.PI / 2;
		...
		var butty1=document.getElementById("ButtonY1");
		
			butty1.addEventListener('click', function (evt) {
			targetPitch = startPitch + 200 * 0.004;
				if(targetPitch > Math.PI / 2) {
					targetPitch = Math.PI / 2;
				} else if(targetPitch < -Math.PI / 2) {
					targetPitch = -Math.PI / 2;
		...
		var butty2=document.getElementById("ButtonY2");
		
			butty2.addEventListener('click', function (evt) {
			targetPitch = startPitch -200 * 0.004;
				if(targetPitch > Math.PI / 2) {
					targetPitch = Math.PI / 2;
				} else if(targetPitch < -Math.PI / 2) {
		...
		var butty3=document.getElementById("ButtonToChage");
		
			butty3.addEventListener('click', function (evt) {
				
			if(currentImage==1){
				diffuseTexture = createTexture(imgDiffuse1);
				currentImage=2;
			}
